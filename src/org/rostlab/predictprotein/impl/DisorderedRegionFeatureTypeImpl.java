 ...
 */
public class DisorderedRegionFeatureTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.rostlab.predictprotein.DisorderedRegionFeatureType
{
    private static final long serialVersionUID = 1L;
    
    public DisorderedRegionFeatureTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.rostlab.predictprotein.DisorderedRegionFeatureType.FeatureString xgetFeatureString()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.rostlab.predictprotein.DisorderedRegionFeatureType.FeatureString target = null;
            target = (org.rostlab.predictprotein.DisorderedRegionFeatureType.FeatureString)get_store().find_element_user(FEATURESTRING$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetFeatureString(org.rostlab.predictprotein.DisorderedRegionFeatureType.FeatureString featureString)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.rostlab.predictprotein.DisorderedRegionFeatureType.FeatureString)get_store().add_element_user(FEATURESTRING$2);
            }
     ...
     */
    public org.rostlab.predictprotein.DisorderedRegionFeatureType.Reliability xgetReliability()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.rostlab.predictprotein.DisorderedRegionFeatureType.Reliability target = null;
            target = (org.rostlab.predictprotein.DisorderedRegionFeatureType.Reliability)get_store().find_element_user(RELIABILITY$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetReliability(org.rostlab.predictprotein.DisorderedRegionFeatureType.Reliability reliability)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.rostlab.predictprotein.DisorderedRegionFeatureType.Reliability)get_store().add_element_user(RELIABILITY$4);
            }
     ...
     */
    public static class FeatureStringImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.rostlab.predictprotein.DisorderedRegionFeatureType.FeatureString
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class ReliabilityImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.rostlab.predictprotein.DisorderedRegionFeatureType.Reliability
    {
        private static final long serialVersionUID = 1L;
