 ...
 */
public class ReqPositiveIntValueTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.rostlab.predictprotein.ReqPositiveIntValueType
{
    private static final long serialVersionUID = 1L;
    
    public ReqPositiveIntValueTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.apache.xmlbeans.XmlPositiveInteger xgetValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlPositiveInteger target = null;
            target = (org.apache.xmlbeans.XmlPositiveInteger)get_store().find_attribute_user(VALUE$0);
            return target;
        }
    }
     ...
     */
    public void xsetValue(org.apache.xmlbeans.XmlPositiveInteger value)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlPositiveInteger)get_store().add_attribute_user(VALUE$0);
            }
            target.set(value);
        }
    }
