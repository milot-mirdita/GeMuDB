 ...
 */
public class SolventAccessibilityFeatureTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.rostlab.predictprotein.SolventAccessibilityFeatureType
{
    private static final long serialVersionUID = 1L;
    
    public SolventAccessibilityFeatureTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.rostlab.predictprotein.SolventAccessibilityFeatureType.FeatureString xgetFeatureString()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.rostlab.predictprotein.SolventAccessibilityFeatureType.FeatureString target = null;
            target = (org.rostlab.predictprotein.SolventAccessibilityFeatureType.FeatureString)get_store().find_element_user(FEATURESTRING$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetFeatureString(org.rostlab.predictprotein.SolventAccessibilityFeatureType.FeatureString featureString)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.rostlab.predictprotein.SolventAccessibilityFeatureType.FeatureString)get_store().add_element_user(FEATURESTRING$2);
            }
     ...
     */
    public org.rostlab.predictprotein.SolventAccessibilityFeatureType.Reliability xgetReliability()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.rostlab.predictprotein.SolventAccessibilityFeatureType.Reliability target = null;
            target = (org.rostlab.predictprotein.SolventAccessibilityFeatureType.Reliability)get_store().find_element_user(RELIABILITY$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetReliability(org.rostlab.predictprotein.SolventAccessibilityFeatureType.Reliability reliability)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.rostlab.predictprotein.SolventAccessibilityFeatureType.Reliability)get_store().add_element_user(RELIABILITY$4);
            }
     ...
     */
    public static class FeatureStringImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.rostlab.predictprotein.SolventAccessibilityFeatureType.FeatureString
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class ReliabilityImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.rostlab.predictprotein.SolventAccessibilityFeatureType.Reliability
    {
        private static final long serialVersionUID = 1L;
