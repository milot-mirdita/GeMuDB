                           ...
                           */
                           public  gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkType[] getLink(){
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localLink);
                               list.add(param);
                               this.localLink =
                             (gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkType[])list.toArray(
                            new gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkType[list.size()]);
                ...
                if (localLinkTracker){
                                       if (localLink!=null){
                                            for (int i = 0;i < localLink.length;i++){
                                                if (localLink[i] != null){
                                                 localLink[i].serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo","Link"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LinkListType".equals(type)){
                                ...
                                return (LinkListType)gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo","Link").equals(reader.getName())){
                                    ...
                                    list1.add(gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkType.Factory.parse(reader));
                                                        ...
                                                        object.setLink((gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkType.class,
                                                                list1));
