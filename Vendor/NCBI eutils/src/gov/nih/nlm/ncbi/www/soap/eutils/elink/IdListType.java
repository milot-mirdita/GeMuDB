                           ...
                           */
                           public  gov.nih.nlm.ncbi.www.soap.eutils.elink.IdType[] getId(){
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localId);
                               list.add(param);
                               this.localId =
                             (gov.nih.nlm.ncbi.www.soap.eutils.elink.IdType[])list.toArray(
                            new gov.nih.nlm.ncbi.www.soap.eutils.elink.IdType[list.size()]);
                ...
                if (localIdTracker){
                                       if (localId!=null){
                                            for (int i = 0;i < localId.length;i++){
                                                if (localId[i] != null){
                                                 localId[i].serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink","Id"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IdListType".equals(type)){
                                ...
                                return (IdListType)gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(gov.nih.nlm.ncbi.www.soap.eutils.elink.IdType.Factory.parse(reader));
                                                        ...
                                                        object.setId((gov.nih.nlm.ncbi.www.soap.eutils.elink.IdType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                gov.nih.nlm.ncbi.www.soap.eutils.elink.IdType.class,
                                                                list1));
