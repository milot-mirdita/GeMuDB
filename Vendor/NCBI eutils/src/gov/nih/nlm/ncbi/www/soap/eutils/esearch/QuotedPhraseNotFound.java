         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                            ...
                            java.lang.String _localName = "QuotedPhraseNotFound";
                               ...
                               if (serializeType){
                                   ...
                                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                           namespacePrefix+":QuotedPhraseNotFound",
                                           xmlWriter);
                                   } else {
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                           "QuotedPhraseNotFound",
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                 return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME,
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQuotedPhraseNotFound)
                            },
                            null);
    ...
    public static class Factory{
        ...
        */
        public static QuotedPhraseNotFound parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QuotedPhraseNotFound object =
                new QuotedPhraseNotFound();
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"QuotedPhraseNotFound" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setQuotedPhraseNotFound(
