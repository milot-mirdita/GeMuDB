 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for TranslationStackTypeChoice
                        * This was an Array!
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isTranslationStackTypeChoiceSpecified(){
                               return localTranslationStackTypeChoiceTracker;
                           }
                           ...
                           * @return gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice[]
                           */
                           public  gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice[] getTranslationStackTypeChoice(){
                              ...
                              */
                              public void setTranslationStackTypeChoice(gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice[] param){
                               ...
                               localTranslationStackTypeChoiceTracker = param != null;
                             ...
                             * @param param gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice
                             */
                             public void addTranslationStackTypeChoice(gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localTranslationStackTypeChoice);
                               list.add(param);
                               this.localTranslationStackTypeChoice =
                             (gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice[])list.toArray(
                            new gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TranslationStackType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                      ...
                                      if (localTranslationStackTypeChoice!=null){
                                            for (int i = 0;i < localTranslationStackTypeChoice.length;i++){
                                                if (localTranslationStackTypeChoice[i] != null){
                                                 localTranslationStackTypeChoice[i].serialize(null,xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static TranslationStackType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TranslationStackType object =
                new TranslationStackType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TranslationStackType".equals(type)){
                                ...
                                return (TranslationStackType)gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice.Factory.parse(reader));
                                                        ...
                                                        object.setTranslationStackTypeChoice((gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                gov.nih.nlm.ncbi.www.soap.eutils.esearch.TranslationStackTypeChoice.class,
                                                                list1));
