                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isLinkInfoSpecified(){
                               return localLinkInfoTracker;
                           }
                           ...
                           public  gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkInfoType[] getLinkInfo(){
                              ...
                              */
                              public void setLinkInfo(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkInfoType[] param){
                               ...
                               localLinkInfoTracker = param != null;
                             ...
                             */
                             public void addLinkInfo(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkInfoType param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localLinkInfo);
                               list.add(param);
                               this.localLinkInfo =
                             (gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkInfoType[])list.toArray(
                            new gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkInfoType[list.size()]);
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localId.serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink","Id"),
                                               xmlWriter);
                                         if (localLinkInfoTracker){
                                       if (localLinkInfo!=null){
                                            for (int i = 0;i < localLinkInfo.length;i++){
                                                if (localLinkInfo[i] != null){
                                                 localLinkInfo[i].serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink","LinkInfo"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IdLinkSetType".equals(type)){
                                ...
                                return (IdLinkSetType)gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink","LinkInfo").equals(reader.getName())){
                                    ...
                                    list2.add(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkInfoType.Factory.parse(reader));
                                                        ...
                                                        object.setLinkInfo((gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkInfoType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkInfoType.class,
                                                                list2));
