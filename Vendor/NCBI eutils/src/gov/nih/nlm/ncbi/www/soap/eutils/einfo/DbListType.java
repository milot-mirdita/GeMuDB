                           ...
                           public  java.lang.String[] getDbName(){
                             ...
                             */
                             public void addDbName(java.lang.String param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localDbName);
                               list.add(param);
                               this.localDbName =
                                  ...
                                  for (int i = 0;i < localDbName.length;i++){
                                         ...
                                         if (localDbName[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo",
                                                                              "DbName"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDbName[i]));
                                          } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DbListType".equals(type)){
                                ...
                                return (DbListType)gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    if (reader.isStartElement() ){
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setDbName((java.lang.String[])
